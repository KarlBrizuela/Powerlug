...
<head>
    ...
    <title>Create Freebie - Freebies Management</title>
    <!-- Bootstrap CSS -->
                        ...
                        <form method="POST" action="{{ route('freebies.store') }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input name="unit" class="form-control @error('unit') is-invalid @enderror" value="{{ old('unit') }}" placeholder="e.g. pc, set, hour">
                                    @error('unit')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input name="service" class="form-control @error('service') is-invalid @enderror" value="{{ old('service') }}" placeholder="e.g. Painting, Detailing">
                                    @error('service')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="3" placeholder="Optional description of the freebie">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="schedule_value" class="form-control @error('schedule_value') is-invalid @enderror" value="{{ old('schedule_value') }}" placeholder="Comma separated values (e.g. Mon,Tue or 1,15)">
                            ...
                            <div class="text-end">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-plus-circle"></i> Create Freebie
                                </button>
                            </div>
                        </form>
                    </div>
