                                ...
                                <form action="{{ route('insurance-providers.update', $insuranceProvider->id) }}" method="POST">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <textarea name="banks" class="form-control" rows="4" placeholder="e.g. BDO, Metrobank, BPI">{{ old('banks', is_array($insuranceProvider->banks) ? implode("\n", $insuranceProvider->banks) : $insuranceProvider->banks) }}</textarea>
